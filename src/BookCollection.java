...
public class BookCollection {
    ...
    public ArrayList<Book> startInitialCollection (ArrayList collection, Book book){
    ...
    public Book addToList(String name, String author, boolean status) {
        Book book = new Book(name, author, status);
        collection.add(book);
        return book;
    }

    public Book changeStatus(String name, String author, boolean status){
        Book book = new Book (name, author, status);
